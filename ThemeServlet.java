...
public class ThemeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		AuthorizationServlet.getUserBox().get(1);
	...
	public void addNoteAndShowOnPage(HttpServletRequest request, PrintWriter out) 
			throws ServletException, IOException {
	...
	public void viewNoteAndShowOnPage(HttpServletRequest request, PrintWriter out) 
			throws ServletException, IOException {

		/* step 1 - get all notes of a selected theme for the selected user from MySql DB*/
		// String queryViewNote="SELECT * FROM notes";		
		String queryViewNote = "SELECT * FROM notes WHERE id_author='" 
				+ id_author + "' AND id_topic='" + id_topic	+ "'";
		...
		try {
			while(allNotesOfSelectedThemeForThisUser.next()){
